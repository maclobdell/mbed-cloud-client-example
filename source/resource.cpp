                          ...
                          bool observable, void *cb, void *message_status_cb)
{
    ...
    resource = object_instance->create_dynamic_resource(name, resource_type,
    ...
    resource->set_message_delivery_status_cb(
        (void (*)(const M2MBase &, const M2MBase::MessageDeliveryStatus,
                  const M2MBase::MessageType, void *))message_status_cb,
        NULL);
