                            ...
                            ce_initiator_e initiator)
{
    ...
    switch (status) {
        ...
        case CE_STATUS_ERROR:
            printf(
                "Renewal Error: Operation ended with an unspecified error\n");
            break;
        case CE_STATUS_INVALID_PARAMETER:
            printf("Renewal Error: A parameter provided to the function was "
                   "invalid\n");
            break;
        ...
        case CE_STATUS_ITEM_NOT_FOUND:
            printf("Renewal Error: Attempted to renew a certificate that does "
                   "not exist in storage\n");
            break;
        case CE_STATUS_DEVICE_BUSY:
            printf("Renewal Error: Device currently processing too many "
        ...
        case CE_STATUS_EST_ERROR:
            printf("Renewal Error: Error when requesting the new certificate "
                   "from the EST service\n");
            break;
        ...
        case CE_STATUS_RENEWAL_STATUS_ERROR:
            printf("Renewal Error: Operation failed to create/read/validate "
                   "items\n");
            break;
        case CE_STATUS_FORBIDDEN_REQUEST:
            printf("Renewal Error: Server asked for forbidden request (e.g.: "
                   "the server is not allowed to renew the device's bootstrap "
                   "certificate)\n");
            break;
        case CE_STATUS_ITEM_IS_EMPTY:
            printf("Renewal Error: Item was found in storage but has zero "
                   "length\n");
            break;
        case CE_STATUS_NOT_INITIALIZED:
            printf("Renewal Error: Called CertificateEnrollmentClient API "
